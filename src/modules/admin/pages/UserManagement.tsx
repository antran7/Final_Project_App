...
interface JobRankResponse {
  success?: boolean;
  data?: JobRankData[];
  [key: string]: boolean | JobRankData[] | undefined;
}

interface DepartmentResponse {
  success?: boolean;
  data?: DepartmentData[];
  [key: string]: boolean | DepartmentData[] | undefined;
}

interface ContractResponse {
  success?: boolean;
  data?: ContractData[];
  [key: string]: boolean | ContractData[] | undefined;
}
          ...
          <DialogContent>
            ...
            {employeeData && (
              <>
                ...
                <TextField
                  label="Salary"
                  value={formatNumberWithDots(employeeData.salary)}
                  onChange={(e) => {
                    const rawValue = e.target.value.replace(/\./g, "");
                    if (/^\d*$/.test(rawValue)) {
                      setEmployeeData({
                        ...employeeData,
                        salary: Number(rawValue),
                      });
                    }
                  }}
                  fullWidth
